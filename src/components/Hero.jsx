export default function Hero() {
  ...
  <div className="text-center md:text-left md:w-1/2 px-6">
    <h2 className="text-3xl font-bold mb-4">Transforming Data into Business Intelligence & Insights</h2>
    <p className="text-lg">
    Data Analyst | BI & AI Solutions | KPI Dashboards | Predictive Analytics | BSCS Graduate | Software Engineer | Skilled in Data Visualization, Insights & Growth Optimization | Trusted Freelance
    </p>
  </div>
