export default function Hero() {
  ...
  <div className="text-center md:text-left md:w-1/2 px-6">
    <h2 className="text-3xl font-bold mb-4">Turning Data into Insights & Securing Digital Assets</h2>
    <p className="text-lg">
     Software Engineer, Data Analyst & Cybersecurity Analyst | BSCS Graduate | Trustworthy Freelancer | Skilled in Data Analysis & Visualization, Threat Detection, and Risk Mitigation
    </p>
  </div>
  ...
  <p className="mt-4 text-lg font-semibold">SHAMSHER ALI</p> 
  </div>
